...
This repository houses the R code used for simulation studies within the project titled “*Data-augmented multistate modeling for chronic disease processes using cross-sectional studies: Application to HPV and cervical precancer*” Inside, there are two folders. One folder labeled *utility* contains all utility functions; the other folder labeled *sim* contains the running scripts designed for executing simulations.
