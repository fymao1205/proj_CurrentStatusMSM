...
est_lam01_pwc01_wei_rec20.f <- function(ini, dtw, cuts, lam12, lam10, meanlog, sdlog, Q, sexactive=1){
...
loglik_rec20_exp.f <- function(par, cuts, lam12, lam10, meanlog, sdlog, Q, q1_vec, dtw){
...
score_rec20_exp.f <- function(gradstep=1e-05, par, cuts, lam12, lam10, meanlog, sdlog, Q, q1_vec, dtw){
  
  para.len=length(par)
  
  logL0=loglik_rec20_exp.f(par, cuts, lam12, lam10, meanlog, sdlog, Q, q1_vec, dtw)
...
swvar_rec20_exp.f <- function(gradstep=1e-05, est.res, dtw, cuts, lam12, lam10, meanlog, sdlog, Q, sexactive=1){
  ...
  hess=est.res$hess
  smat=score_rec20_exp.f(gradstep, est.res$est, cuts, lam12, lam10, meanlog, sdlog, Q, q1_vec, dtw)
...
est01.f <- function(ini, dtw, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, sexactive=1){
...
loglik_01.f <- function(par, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, q1_vec, dtw){
...
score_01.f <- function(gradstep=1e-05, par, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, q1_vec, dtw){
  
  para.len=length(par)
  
  logL0=loglik_01.f(par, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, q1_vec, dtw)
  
  logLp.list <- lapply(1:para.len, function(i){
    print(i)
    par.p=par
    par.p[i]=par[i]+gradstep
    loglik_01.f(par.p, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, q1_vec, dtw)
  })
...
swvar_01.f <- function(gradstep=1e-05, est.res, dtw, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, sexactive=1){
  ...
  hess=est.res$hess
  smat=score_01.f(gradstep, est.res$par, cuts, lam12, lam10, lam20, meanlog, sdlog, Q, q1_vec, dtw)
...
#   
# 
# P_Z_g_S.f(13.5, 15, lam01, lam10, lam12, lam20)
# 
...
# 
# 
# Pmat_Z1.f(15:17, lam01, lam10, lam12, lam20, list(meanlog=meanlog, sdlog=sdlog, Q=Q))$p1.marg
